...
zip_files(['held_in_calib/*calib.nwb'], out_path / 'held_in_calib.zip')
zip_files(['minival/*minival.nwb'], out_path / 'minival.zip')
zip_files(['held_out_calib/*calib.nwb'], out_path / 'held_out_calib.zip')