...
files_to_plot = [
    ...
    '/home/bkarpo2/bin/falcon-challenge/data/m1/sub-MonkeyL-held-out-calib/sub-MonkeyL-held-out-calib_ses-20121017_behavior+ecephys.nwb'
]
...
axes.set_xticks(np.array([0, 1500, 2999, 3000, 4500, 6000]))
axes.set_xticklabels(np.array([0, 1500, 3000, 0, 1500, 3000]) * 0.02)

plt.savefig('/home/bkarpo2/projects/falcon_figs/raster_stability.pdf', bbox_inches='tight')
