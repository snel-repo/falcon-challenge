...
EXPERIMENT_NAME = '240513_M2_NoMAD_multidayK'
NUM_SAMPLES = 50 # number of samples to take from the search space
RESOURCES_PER_TRIAL = {'cpu': 2, 'gpu': 0.1} # resources to allocate to each process
