r"""
    ...
    Once your model is trained with the NDT2 codebase, move the checkpoint (and zscore file) to an accessible directory and provide the path here.
    e.g.
    python decoder_demos/ndt2_sample.py --evaluation local --split h1 --phase minival --model-path ./local_data/ndt2_h1_sample.pth --zscore-path ./local_data/ndt2_zscore_h1.pt
"""
