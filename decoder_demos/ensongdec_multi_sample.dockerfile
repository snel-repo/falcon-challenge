...
# NOTE: The environment variables PREDICTION_PATH, PREDICTION_PATH_LOCAL, GT_PATH, , and EVAL_models_PATH are used by the evaluator and should not be changed.
...
# Note that Docker cannot easily import across symlinks; make sure models is not symlinked
ADD b1_models/* models/
ENV ALL_MODEL_PATHS "models/z_r12r13_21_2021.06.26_held_in_calib.nwb_FFNN_20240604_092642.pt models/z_r12r13_21_2021.06.27_held_in_calib.nwb_FFNN_20240604_092705.pt models/z_r12r13_21_2021.06.28_held_in_calib.nwb_FFNN_20240604_093216.pt models/z_r12r13_21_2021.06.30_held_out_oracle.nwb_FFNN_20240604_093453.pt models/z_r12r13_21_2021.07.01_held_out_oracle.nwb_FFNN_20240604_095827.pt models/z_r12r13_21_2021.07.05_held_out_oracle.nwb_FFNN_20240604_095944.pt"
...
ENV ALL_CFG_PATHS "models/z_r12r13_21_2021.06.26_held_in_calib.nwb_FFNN_20240604_092642_metadata.json models/z_r12r13_21_2021.06.27_held_in_calib.nwb_FFNN_20240604_092705_metadata.json models/z_r12r13_21_2021.06.28_held_in_calib.nwb_FFNN_20240604_093216_metadata.json models/z_r12r13_21_2021.06.30_held_out_oracle.nwb_FFNN_20240604_093453_metadata.json models/z_r12r13_21_2021.07.01_held_out_oracle.nwb_FFNN_20240604_095827_metadata.json models/z_r12r13_21_2021.07.05_held_out_oracle.nwb_FFNN_20240604_095944_metadata.json"
...
CMD ["/bin/bash", "-c", \
    "python decode.py --evaluation $EVALUATION_LOC --model-paths $ALL_MODEL_PATHS --model-cfg-paths $ALL_CFG_PATHS --split $SPLIT --phase $PHASE --batch-size $BATCH_SIZE"]
