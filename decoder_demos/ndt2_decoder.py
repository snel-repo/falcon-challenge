r"""
    Wrapper for NDT2 decoder. 
    NDT2 models must be trained with the `context_general_bci` codebase: https://github.com/joel99/context_general_bci
    This decoder is a wrapper around the NDT2 model for FALCON, and is not intended to be used for training.
"""
